...
namespace Builder.RealWorld
{
    ...
    internal class AeroNaveBuilder : VehicleBuilder
    {
        public AeroNaveBuilder()
        {
            vehicle = new Vehicle("AeroNave");
        }


        public override void BuildFrame()
        {
            vehicle["frame"] = "AeroNave Frame";
        }
