...
namespace Prototype.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            colormanager["brown"] = new Color(100, 25, 25);

            colormanager["pink"] = new Color(50, 40, 50);
            ...
            var color5 = colormanager["brown"].Clone() as Color;

            var color6 = colormanager["pink"].Clone() as Color;
